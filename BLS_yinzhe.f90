program main_exoplanet
implicit none

integer(kind=4),parameter :: N_data=1440
integer(kind=4) :: i,j,k
real(kind=8)    :: data1(1:N_data,1:4)

open(unit=10,file='/data/mayinzhe/exoplanet/code1/datafile/data1.dat')

do i=1,N_data,1
 if(mod(i,500)==0) write(*,*) 'reading i=',i
 read(10,*) data1(i,1),data1(i,2),data1(i,3),data1(i,4)
end do
